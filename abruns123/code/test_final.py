...
def test_gauss_newton():
    """
    test_gauss_newton verifies that the gauss_newton function
    can successfully carry out a nonlinear fit
    given good initial parameters.
    """
...
def test_residuals():
    ...
    y =final.model(x, params[0], params[1], params[2])  # Corresponding y values for y = x^2 + 2x + 3
