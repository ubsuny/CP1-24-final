...
def test_get_temp():
    ...
    '''
    temp = get_temp('/workspaces/CP1-24-final/iglesias-cardinale/Final/Data/ic001_sinewalk.md')
    assert temp == 38
...
def test_list_files():
    ...
    '''
    num = len(list_files('/workspaces/CP1-24-final/iglesias-cardinale/Final/Data', 'ic0', '.md'))
